    ...
    <div className="min-h-screen w-full flex bg-white overflow-hidden font-sans selection:bg-amber-100 selection:text-amber-900">
      ...
      {showVerifyModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-white rounded-3xl p-8 max-w-md w-full mx-4 shadow-2xl relative animate-in zoom-in-95 duration-300 border border-slate-100">
                <button 
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 relative z-10 bg-white">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
             <div className="absolute top-[20%] -left-20 w-96 h-96 bg-amber-200/20 rounded-full blur-[100px]" />
        ...
        <div className="max-w-md w-full mx-auto mt-12 animate-fade-in-up relative z-10">
            ...
            <div className="mb-10">
              ...
              <h1 className="text-4xl lg:text-5xl font-extrabold text-slate-900 mb-4 tracking-tight">
                Masuk ke <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-600">LISAN</span>
              </h1>
              <p className="text-slate-500 text-lg leading-relaxed">
                Lanjutkan perjalanan inklusifmu. Setiap langkah kecil membawa perubahan besar.
              </p>
            </div>
              ...
              <div className="group">
                ...
                <div className="relative transition-all duration-300 transform group-focus-within:-translate-y-1">
                  <input
                    type="text"
                    required
                    className="w-full h-14 pl-12 pr-4 rounded-2xl border border-slate-200 bg-slate-50/30 text-slate-900 font-medium placeholder:text-slate-400 focus:bg-white focus:ring-4 focus:ring-amber-500/20 focus:border-amber-500 outline-none transition-all duration-300"
              ...
              <div className="group">
                ...
                <div className="relative transition-all duration-300 transform group-focus-within:-translate-y-1">
                  <input
                    ...
                    required
                    className="w-full h-14 pl-12 pr-12 rounded-2xl border border-slate-200 bg-slate-50/30 text-slate-900 font-medium placeholder:text-slate-400 focus:bg-white focus:ring-4 focus:ring-amber-500/20 focus:border-amber-500 outline-none transition-all duration-300"
                    placeholder="••••••••"
      ...
      <div className="hidden lg:flex w-1/2 bg-[#0F0F16] relative overflow-hidden items-center justify-center p-16 text-center z-10">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-orange-600/30 rounded-full blur-[130px] animate-pulse-slow pointer-events-none" />
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-amber-500/20 rounded-full blur-[100px] pointer-events-none" />
        <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-yellow-500/20 rounded-full blur-[90px] pointer-events-none" />
        
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-amber-400/20 rounded-full blur-[70px] pointer-events-none mix-blend-screen" />
        
        <div className="absolute inset-0 bg-[url('/noise.png')] opacity-[0.07] mix-blend-overlay pointer-events-none" />
        
        <div className="relative z-10 max-w-lg">
          <div className="mb-10 inline-flex p-5 rounded-[2rem] bg-white/5 border border-amber-500/30 backdrop-blur-md shadow-[0_0_50px_rgba(245,158,11,0.2)] rotate-3 hover:rotate-0 transition-transform duration-500 group cursor-default">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-tr from-amber-500 to-yellow-400 opacity-60 blur-xl absolute top-4 left-4 group-hover:opacity-80 transition-all duration-500" />
              <div className="relative w-20 h-20 flex items-center justify-center bg-gradient-to-br from-white/10 to-transparent rounded-2xl border border-white/10 group-hover:border-amber-500/30 transition-colors">
                <span className="text-5xl drop-shadow-[0_0_15px_rgba(251,191,36,0.8)] animate-pulse">✨</span>
              </div>
          </div>
          
          <h2 className="text-5xl xl:text-6xl font-black text-white mb-8 leading-[1.15] drop-shadow-lg">
            "Di balik <span className="text-slate-500 inline-block transform hover:scale-105 transition-transform duration-300">gelap</span>, <br/>
            terbitlah <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 via-amber-400 to-orange-400 drop-shadow-[0_0_25px_rgba(251,191,36,0.6)] italic">cahaya</span>."
          </h2>
          
          <p className="text-slate-400 text-lg font-light leading-relaxed max-w-sm mx-auto border-t border-white/10 pt-6">
            Kembali terhubung, kembali berkarya. Temukan kilau inspirasimu bersama <strong className="text-amber-400">LISAN</strong>.
          </p>
        </div>
      </div>
    </div>
