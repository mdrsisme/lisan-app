...
export default function CreateFaqScreen() {
  ...
  return (
    <AdminLayout>
      <div className="w-full max-w-6xl mx-auto space-y-8 animate-fade-in-up pb-10 px-6">
        <Notification
          type={notif.type}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full px-5 py-4 rounded-xl bg-slate-50 border-transparent focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none font-semibold text-slate-700 appearance-none cursor-pointer"
                    >
                      {CATEGORIES.map((cat) => (
