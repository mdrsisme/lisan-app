    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans pb-20">
      ...
      <div className="flex items-center justify-center px-4 sm:px-6 py-12">
        ...
        <div className="relative w-full max-w-2xl group">
            ...
            <div className="absolute -top-10 -left-10 w-64 h-64 bg-blue-600 rounded-full blur-[100px] opacity-20 animate-pulse mix-blend-multiply" />
            <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-indigo-500 rounded-full blur-[100px] opacity-20 animate-pulse mix-blend-multiply" />
            ...
            <div className="relative z-10 w-full animate-in fade-in slide-in-from-bottom-8 duration-700">
                ...
                <div className="bg-white/80 backdrop-blur-2xl border border-white/60 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] rounded-[2.5rem] overflow-hidden">
                    ...
                    <div className="h-40 w-full relative bg-slate-900 overflow-hidden">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-blue-600 rounded-full blur-[80px] opacity-60 mix-blend-screen animate-pulse" />
                        ...
                        <div className="absolute bottom-0 left-0 p-8 z-10">
                            ...
                            <p className="text-slate-400 text-sm font-medium mt-1 pl-11">Kelola password dan privasi Anda.</p>
                        </div>
                    </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex justify-end">
                                <button 
                                    ...
                                    disabled={isLoading}
                                    className="px-8 py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-sm shadow-lg shadow-blue-500/30 hover:-translate-y-0.5 transition-all disabled:opacity-70 disabled:transform-none flex items-center gap-2"
                                >
      ...
      {isDeleteOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-[2.5rem] p-8 w-full max-w-sm shadow-2xl animate-in zoom-in-95 duration-300 border border-slate-100">
              
              <div className="w-20 h-20 bg-rose-50 rounded-full flex items-center justify-center mx-auto mb-6 text-rose-500 border border-rose-100 shadow-inner">
              ...
              <div className="flex gap-3">
                 ...
                 <button 
                    ...
                    disabled={isLoading}
                    className="flex-1 py-3.5 rounded-2xl bg-gradient-to-r from-rose-500 to-red-600 font-bold text-white hover:shadow-lg hover:shadow-rose-500/30 transition-all flex items-center justify-center gap-2 active:scale-95"
                 >
